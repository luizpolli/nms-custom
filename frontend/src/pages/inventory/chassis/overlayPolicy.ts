...
export const OVERLAY_POLICY: OverlayPolicy = {
  // ASR920 12-port variant base SVGs are generated scaffolds with a single
  // background rectangle — no module artwork at all.  All overlays must render.
  // (No entries needed: default is true for every type.)

  // NCS55A1 base SVG has ~3000 paths of full artwork.  If specific hotspot
  // types produce visible doubling, add them here.  Verified clean for now.
};

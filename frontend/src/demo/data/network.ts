...
export const DEMO_TOPOLOGY = {
  nodes: [
    { id: DEV.NCS55_CDMX,  label: 'ncs55a1-cdmx-core-01',  role: 'core',        site: 'MEX-CDMX-01', status: 'reachable',   x: 400, y: 300 },
    { id: DEV.NCS55_GDL,   label: 'ncs55a1-gdl-core-01',   role: 'core',        site: 'MEX-GDL-01',  status: 'reachable',   x: 700, y: 150 },
    { id: DEV.NCS55_MTY,   label: 'ncs55a1-mty-core-01',   role: 'core',        site: 'MEX-MTY-01',  status: 'degraded',    x: 700, y: 450 },
    { id: DEV.NCS560_CDMX, label: 'ncs560-cdmx-agg-01',    role: 'aggregation', site: 'MEX-CDMX-01', status: 'reachable',   x: 200, y: 300 },
    { id: DEV.NCS560_GDL,  label: 'ncs560-gdl-agg-01',     role: 'aggregation', site: 'MEX-GDL-01',  status: 'reachable',   x: 900, y: 150 },
    { id: DEV.ASR9010_1,   label: 'asr9010-cdmx-pe-01',    role: 'pe',          site: 'MEX-CDMX-01', status: 'reachable',   x: 300, y: 200 },
    { id: DEV.ASR9010_2,   label: 'asr9010-cdmx-pe-02',    role: 'pe',          site: 'MEX-CDMX-01', status: 'reachable',   x: 300, y: 400 },
    { id: DEV.ASR9010_3,   label: 'asr9010-gdl-pe-01',     role: 'pe',          site: 'MEX-GDL-01',  status: 'unreachable', x: 900, y: 250 },
    { id: DEV.ASR920_1,    label: 'asr920-cdmx-acc-01',    role: 'access',      site: 'MEX-CDMX-02', status: 'reachable',   x: 100, y: 200 },
    { id: DEV.ASR920_2,    label: 'asr920-cdmx-acc-02',    role: 'access',      site: 'MEX-CDMX-03', status: 'reachable',   x: 100, y: 400 },
    { id: DEV.ASR920_3,    label: 'asr920-gdl-acc-01',     role: 'access',      site: 'MEX-GDL-02',  status: 'degraded',    x: 1050, y: 150 },
    { id: DEV.ASR920_4,    label: 'asr920-mty-acc-01',     role: 'access',      site: 'MEX-MTY-02',  status: 'reachable',   x: 850, y: 500 },
    { id: DEV.ASR5K_1,     label: 'asr5000-cdmx-mobile-01', role: 'mobile-gw', site: 'MEX-CDMX-01', status: 'reachable',   x: 500, y: 450 },
    { id: DEV.ASR5K_2,     label: 'asr5000-gdl-mobile-01',  role: 'mobile-gw', site: 'MEX-GDL-01',  status: 'reachable',   x: 750, y: 50  },
    { id: DEV.ASR5K_3,     label: 'asr5000-mty-mobile-01',  role: 'mobile-gw', site: 'MEX-MTY-01',  status: 'reachable',   x: 600, y: 550 },
  ],
  links: [
    // Core mesh
